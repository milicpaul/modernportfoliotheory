...
class PortfolioUtilities():
    ...
    def plot_series_temporelles2(self, df, sharpe_ratio=None, rendement=None, volatilite=None,
                                title="Évolution des Séries Économiques", xlabel="Date", ylabel="Valeur"):
        """
        Affiche un graphe de séries temporelles à partir d'un DataFrame Pandas.
        ...
        # Tracer chaque série et ajouter un label directement sur la courbe
        for col in df.columns:
            ax.plot(df.index, df[col], label=col)
        ...
        # Activer l'échelle logarithmique
        ax.set_yscale("log")
